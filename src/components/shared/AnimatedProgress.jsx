...
/**
 * AnimatedProgress — a springy, glowing progress bar replacement.
 * Props: value (0-100), className, color (tailwind class or hex), showGlow
 */
export default function AnimatedProgress({ value = 0, className, color, showGlow = true, height = "h-2.5" }) {
