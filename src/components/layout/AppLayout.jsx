...
import { soundNav, soundMenuOpen, soundMenuClose } from "@/hooks/useSound";
...
function IconNotifications({ active }) {
...
function NavItemLink({ item, isActive, onClick }) {
