...
import { type Streak } from "@/types/entities";
...
interface AchievementItem extends AchievementDef {
  unlocked: boolean;
}
...
export function useAchievements({ streaks, todayProgress, weekProgress, allCheckedInToday, totalRewards }: AchievementContext): AchievementItem[] {
  return useMemo(() => {
...
export default function AchievementsPanel({ achievements }: { achievements: AchievementItem[] }) {
