...
import { soundCashOut, soundPaid } from "@/hooks/useSound";
...
export default function Bank() {
  ...
  const { data: streaks = [] } = useQuery({ queryKey: ["streaks"], queryFn: () => base44.entities.Streak.list(), refetchInterval: 1000 });
  const { data: payouts = [] } = useQuery({ queryKey: ["payouts"], queryFn: () => base44.entities.Payout.list(), refetchInterval: 1000 });
